...
class bigfriesController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myImageView.image = UIImage(named: "bigfries.png")//
    ...
    @objc func confirm() {
        ...
        let okAction = UIAlertAction(
            ...
            handler: {
                ...
                self.present(bigfriesTimeController(), animated: false, completion: nil)//
        })
