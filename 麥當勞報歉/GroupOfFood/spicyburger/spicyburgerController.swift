...
class spicyburgerController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myImageView.image = UIImage(named: "spicyburger.png")//
    ...
    @objc func confirm() {
        ...
        let okAction = UIAlertAction(
            ...
            handler: {
                ...
                self.present(spicyburgerTimeController(), animated: false, completion: nil)//
        })
